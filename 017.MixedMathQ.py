...
str1,str2 = "",""
j=0
count=int(input("Please enter the number of questions："))
while j<count:
    if j<count:                              # 随机产生"+"或 "-"号
...
with open('key.txt','w') as f:
    f.write(str2)
print(count,"Mixed addition and subtraction questions：")    
print(str1)
print(count,"Mixed addition and subtraction questions (with answers)：")  
print(str2)
